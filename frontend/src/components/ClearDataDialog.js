  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-[#1C2540] border border-red-500/30 rounded-2xl shadow-2xl w-full max-w-md">
        ...
        <div className="px-6 py-5 space-y-4">
            ...
            <div className="space-y-3">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 bg-[#F1F5F9] border border-[#E2E8F0] rounded-xl text-[#0F172A] focus:outline-none focus:border-red-500/50"
                >
          ...
          <label className="flex items-start gap-3 cursor-pointer group">
            ...
            <div className="flex-1">
              <span className="text-sm text-[#0F172A] font-medium block">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-[#F1F5F9] border border-[#E2E8F0] rounded-xl text-[#0F172A] placeholder-[#475569] focus:outline-none focus:border-red-500/50 font-mono"
              disabled={!checkbox}
            />
        ...
        {/* Footer */}
        <div className="flex justify-end gap-3 px-6 py-4 border-t border-[#E2E8F0] bg-[#F8FAFC]/60">
          <button
            onClick={handleClose}
            className="px-5 py-2.5 text-sm font-semibold text-[#64748B] border border-[#E2E8F0] rounded-xl hover:bg-white/5 transition-colors"
          >
            Cancel
          </button>
          <button
            ...
            disabled={!isValid}
            className="px-5 py-2.5 text-sm font-semibold bg-red-500 text-[#0F172A] rounded-xl hover:bg-red-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-red-500"
          >
            Delete Permanently
          </button>
        </div>
