...
const features = [
  ...
  { icon: FiCalendar,    color: 'bg-amber-50 text-amber-600',        title: 'Holiday Management',               desc: 'Configure government and office holidays with automatic attendance rule adjustments.', benefits: ['Government holiday calendar','Custom office holidays','Automatic attendance rules','Holiday notifications'] },
  { icon: FiFileText,    color: 'bg-indigo-50 text-indigo-600',      title: 'Reports & Analytics',              desc: 'Generate detailed attendance reports with customizable date ranges. Export in PDF and Excel.', benefits: ['Customizable date ranges','PDF & Excel export','Employee-wise reports','Attendance statistics'] },
  { icon: FiShield,      color: 'bg-red-50 text-red-500',            title: 'Device Fingerprinting',            desc: 'Advanced device fingerprinting identifies unique devices and prevents unauthorized access.', benefits: ['Unique device identification','Device change alerts','Prevent device sharing','Security audit trails'] },
  ...
  { icon: FiBarChart2,   color: 'bg-teal-50 text-teal-600',          title: 'Real-Time Dashboard',              desc: "Monitor attendance in real-time with intuitive dashboards for both admins and employees.", benefits: ['Real-time attendance stats','Present/Absent overview','Late arrivals tracking','Visual analytics'] },
  ...
  { icon: FiAlertCircle, color: 'bg-rose-50 text-rose-600',          title: 'Audit Logs & Monitoring',          desc: 'Comprehensive audit logging tracks all system activities and security events.', benefits: ['Complete activity tracking','Security event monitoring','Failed login alerts','Detailed audit reports'] },
  { icon: FiCheckCircle, color: 'bg-emerald-50 text-emerald-600',    title: 'Work From Home Support',           desc: 'Dedicated WFH attendance tracking with flexible validation rules for hybrid work.', benefits: ['WFH attendance marking','Flexible validation rules','Hybrid work support','Remote work analytics'] },
];
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#F8FAFC]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              { title: 'For Administrators', items: ['Complete employee management dashboard','Real-time attendance monitoring','Customizable attendance policies','Comprehensive reporting and analytics','Security logs and audit trails'] },
              { title: 'For Employees',      items: ['Simple one-tap check-in and check-out','View attendance history and statistics','Mobile-friendly interface','Profile management and password reset','Clear feedback on attendance status'] },
            ].map(({ title, items }) => (
